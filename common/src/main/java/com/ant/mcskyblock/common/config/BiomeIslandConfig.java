...
public class BiomeIslandConfig {
    ...
    public static void defaults() {
        SETTINGS.put(new ResourceLocation("minecraft:plains")                   , toIsland("vanilla", "grass_block"               , "water" , "oak_sapling"));
        ...
        SETTINGS.put(new ResourceLocation("minecraft:forest")                   , toIsland("vanilla", "podzol"                    , null    , "spruce_sapling"));
        ...
        SETTINGS.put(new ResourceLocation("minecraft:dark_forest")              , toIsland("vanilla", "grass_block"               , null    , "dark_oak_sapling"));
        SETTINGS.put(new ResourceLocation("minecraft:old_growth_birch_forest")  , toIsland("vanilla", "grass_block"               , null    , "dark_oak_sapling"));
        SETTINGS.put(new ResourceLocation("minecraft:old_growth_pine_taiga")    , toIsland("vanilla", "grass_block"               , null    , "dark_oak_sapling"));
        SETTINGS.put(new ResourceLocation("minecraft:old_growth_spruce_taiga")  , toIsland("vanilla", "grass_block"               , null    , "dark_oak_sapling"));
        SETTINGS.put(new ResourceLocation("minecraft:taiga")                    , toIsland("vanilla", "grass_block"               , null    , "rose_bush"));
        SETTINGS.put(new ResourceLocation("minecraft:snowy_taiga")              , toIsland("vanilla", "grass_block"               , null    , "spruce_sapling"));
        SETTINGS.put(new ResourceLocation("minecraft:savanna")                  , toIsland("vanilla", "grass_block"               , null    , "acacia_sapling"));
        SETTINGS.put(new ResourceLocation("minecraft:savanna_plateau")          , toIsland("vanilla", "grass_block"               , null    , "acacia_sapling"));
        ...
        SETTINGS.put(new ResourceLocation("minecraft:windswept_savanna")        , toIsland("vanilla", "coarse_dirt"               , null    , "acacia_sapling"));
        SETTINGS.put(new ResourceLocation("minecraft:jungle")                   , toIsland("vanilla", "grass_block"               , null    , "jungle_sapling"));
        SETTINGS.put(new ResourceLocation("minecraft:sparse_jungle")            , toIsland("vanilla", "grass_block"               , null    , "jungle_sapling"));
        SETTINGS.put(new ResourceLocation("minecraft:bamboo_jungle")            , toIsland("vanilla", "grass_block"               , null    , "bamboo"));
        SETTINGS.put(new ResourceLocation("minecraft:badlands")                 , toIsland("vanilla", "terracotta"                , null    , "dead_bush"));
        SETTINGS.put(new ResourceLocation("minecraft:eroded_badlands")          , toIsland("vanilla", "red_terracotta"            , null    , "dead_bush"));
        SETTINGS.put(new ResourceLocation("minecraft:wooded_badlands")          , toIsland("vanilla", "orange_terracotta"         , null    , "oak_sapling"));
        SETTINGS.put(new ResourceLocation("minecraft:meadow")                   , toIsland("vanilla", "grass_block"               , null    , "bee_nest"));
        SETTINGS.put(new ResourceLocation("minecraft:grove")                    , toIsland("vanilla", "snow_block"                , null    , "spruce_sapling"));
        SETTINGS.put(new ResourceLocation("minecraft:snowy_slopes")             , toIsland("vanilla", "snow_block"                , null    , "snow"));
        ...
        SETTINGS.put(new ResourceLocation("minecraft:mushroom_fields")          , toIsland("vanilla", "mycelium"                  , null    , "red_mushroom"));
        SETTINGS.put(new ResourceLocation("minecraft:dripstone_caves")          , toIsland("vanilla", "dripstone_block"           , null    , "pointed_dripstone"));
        SETTINGS.put(new ResourceLocation("minecraft:lush_caves")               , toIsland("vanilla", "moss_block"                , null    , "flowering_azalea"));
        SETTINGS.put(new ResourceLocation("minecraft:deep_dark")                , toIsland("vanilla", "sculk_catalyst"            , null    , "sculk_shrieker"));
        SETTINGS.put(new ResourceLocation("minecraft:nether_wastes")            , toIsland("vanilla", "netherrack"                , null    , "brown_mushroom"));
        SETTINGS.put(new ResourceLocation("minecraft:warped_forest")            , toIsland("vanilla", "warped_nylium"             , null    , "warped_fungus"));
        SETTINGS.put(new ResourceLocation("minecraft:crimson_forest")           , toIsland("vanilla", "crimson_nylium"            , null    , "crimson_fungus"));
