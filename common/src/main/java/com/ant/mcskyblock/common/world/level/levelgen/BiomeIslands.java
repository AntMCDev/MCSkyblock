...
public class BiomeIslands {
    public static final Map<String, IslandType> SETTINGS = Map.<String, IslandType>ofEntries(
            ...
            entry("windswept_gravelly_hills" , new AccessoryIslandType(com.ant.mcskyblock.common.world.level.block.Blocks.staticGravel(), Blocks.GRAVEL)),
            ...
            entry("deep_ocean"               , new AccessoryIslandType(com.ant.mcskyblock.common.world.level.block.Blocks.staticGravel(), Blocks.DRIED_KELP_BLOCK)),
            entry("cold_ocean"               , new AccessoryIslandType(com.ant.mcskyblock.common.world.level.block.Blocks.staticGravel(), Blocks.DRIED_KELP_BLOCK)),
            entry("deep_cold_ocean"          , new AccessoryIslandType(com.ant.mcskyblock.common.world.level.block.Blocks.staticGravel(), Blocks.DRIED_KELP_BLOCK)),
