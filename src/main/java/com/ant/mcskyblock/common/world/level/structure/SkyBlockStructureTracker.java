...
public class SkyBlockStructureTracker {
    ...
    public static void rescan(){
        ...
        enabledMap.put( "minecraft:shipwreck_beached",       SkyBlockConfig.STRUCTURES.GEN_SHIPWRECK);
        ...
        enabledMap.put( "minecraft:ocean_ruin_cold",         SkyBlockConfig.STRUCTURES.GEN_OCEAN_RUIN);
        enabledMap.put( "minecraft:ocean_ruin_warm",         SkyBlockConfig.STRUCTURES.GEN_OCEAN_RUIN);
        ...
        enabledMap.put( "minecraft:village_plains",          SkyBlockConfig.STRUCTURES.GEN_VILLAGE);
        enabledMap.put( "minecraft:village_desert",          SkyBlockConfig.STRUCTURES.GEN_VILLAGE);
        enabledMap.put( "minecraft:village_savanna",         SkyBlockConfig.STRUCTURES.GEN_VILLAGE);
        enabledMap.put( "minecraft:village_snowy",           SkyBlockConfig.STRUCTURES.GEN_VILLAGE);
        enabledMap.put( "minecraft:village_taiga",           SkyBlockConfig.STRUCTURES.GEN_VILLAGE);
        enabledMap.put( "minecraft:ruined_portal",           SkyBlockConfig.STRUCTURES.GEN_RUINED_PORTAL);
        enabledMap.put( "minecraft:ruined_portal_desert",    SkyBlockConfig.STRUCTURES.GEN_RUINED_PORTAL);
        enabledMap.put( "minecraft:ruined_portal_jungle",    SkyBlockConfig.STRUCTURES.GEN_RUINED_PORTAL);
        enabledMap.put( "minecraft:ruined_portal_swamp",     SkyBlockConfig.STRUCTURES.GEN_RUINED_PORTAL);
        enabledMap.put( "minecraft:ruined_portal_mountain",  SkyBlockConfig.STRUCTURES.GEN_RUINED_PORTAL);
        enabledMap.put( "minecraft:ruined_portal_ocean",     SkyBlockConfig.STRUCTURES.GEN_RUINED_PORTAL);
        enabledMap.put( "minecraft:ruined_portal_nether",    SkyBlockConfig.STRUCTURES.GEN_RUINED_PORTAL);
